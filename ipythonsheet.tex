...
If automagic is enabled, the \% sign in front of magic commands is
optional.
...
\begin{tabular}{@{}p{\MyLen}%
  ...
  \verb!%psearch! \textit{var*} \verb!int!  & List variables matching ``var*'' of type int. \\
...
\begin{tabular}{@{}p{\the\MyLen}%
  ...
  \verb!%logstart! \textit{filename}  & Start logging to named file. \\
...
\begin{tabular}{@{}p{\the\MyLen}%
  ...
  \verb!%bookmark! \textit{name} & Bookmark current working dir.\\
  \verb!%bookmark! \textit{name path}  & Bookmark path.\\
  \verb!%bookmark -l!  & List bookmarks.\\
  \verb!%dhist! & List history of directories visited.\\
